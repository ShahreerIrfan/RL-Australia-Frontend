    ...
    if (!order) {
      return (
        <div className="bg-white border border-gray-150 rounded-2xl p-12 text-center shadow-xs">
          ...
          <button onClick={() => setSelectedOrderId(null)} className="text-xs font-bold text-[#047857] hover:underline mt-2">
            Back to Orders list
          </button>
        </div>
      )
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 pb-5">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-black text-gray-950">
              Order <span className="text-[#047857]">#{order.order_number || order.id.slice(0, 8)}</span>
            </h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-1.5 bg-[#047857] hover:bg-[#035f43] text-white text-xs font-bold rounded-xl transition-all shadow-sm shadow-emerald-600/10"
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full text-xs font-bold bg-gray-50/50 border border-gray-200 rounded-xl px-3 py-2.5 focus:bg-white focus:outline-none focus:border-[#047857] transition-all cursor-pointer"
                  >
            ...
            <div className="bg-white border border-gray-150 rounded-2xl p-5 shadow-xs text-xs space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1.5 text-left">
                  <h4 className="font-bold text-gray-400 uppercase tracking-wider text-[10px]">Customer</h4>
                ...
                <div className="space-y-1.5 text-left">
                  <h4 className="font-bold text-gray-400 uppercase tracking-wider text-[10px]">Order Info</h4>
                  ...
                  <div className="flex justify-between items-center text-xs font-semibold text-gray-600">
                    ...
                    <span className="text-[#047857] font-black">{convertToLocale({ amount: order.total, currency_code: "aud" })}</span>
                  </div>
                  <div className="flex justify-between items-center text-xs font-semibold text-gray-600">
            ...
            <div className="bg-white border border-gray-150 rounded-2xl shadow-xs overflow-hidden">
                ...
                <table className="w-full text-xs text-left">
                  ...
                  <tbody className="divide-y divide-gray-100 font-semibold text-gray-700">
                    {itemsList.map((item: any, idx: number) => {
                      ...
                      return (
                        <tr key={idx} className="hover:bg-gray-55/10">
                    ...
                    <tr className="bg-gray-50/30">
                      ...
                      <td className="px-5 py-4 font-extrabold text-gray-900" colSpan={1}>
              ...
              <div className="bg-gray-50/50 p-6 border-t border-gray-150 flex flex-col items-end gap-2.5 text-xs text-gray-600 font-bold select-none text-right">
                ...
                <div className="flex justify-between w-64 text-sm font-black text-gray-900">
                  ...
                  <span className="text-[#047857] text-base font-black">
          ...
          <div className="lg:col-span-4 space-y-6 text-left">
            ...
            <div className="bg-white border border-gray-150 rounded-2xl p-5 shadow-xs">
              ...
              <div className="space-y-3">
                <select className="w-full text-xs font-semibold bg-gray-50/50 border border-gray-200 rounded-xl px-3 py-2.5 focus:bg-white focus:outline-none focus:border-[#047857] transition-all cursor-pointer">
            ...
            <div className="bg-white border border-gray-150 rounded-2xl p-5 shadow-xs space-y-4">
              ...
              <div className="space-y-3 pt-2 border-t border-gray-100">
                <textarea
                  ...
                  rows={3}
                  className="w-full text-xs font-semibold bg-gray-50/50 border border-gray-200 rounded-xl px-3 py-2.5 focus:bg-white focus:outline-none focus:border-[#047857] transition-all resize-none"
                />
                <button
                  onClick={async () => {
                  ...
                  className="w-full bg-[#047857] hover:bg-[#035f43] disabled:opacity-50 text-white py-2 rounded-xl text-xs font-bold transition-all shadow-sm shadow-emerald-600/10"
                >
                  Add Private Note
                </button>
              </div>
            ...
            <div className="bg-white border border-gray-150 rounded-2xl p-5 shadow-xs">
              ...
              >
                <FileText className="w-4 h-4 text-[#047857]" /> PDF Invoice
              </button>
            </div>
    ...
    <div className="space-y-6 text-left">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
        ...
        <div className="bg-white border border-gray-150 rounded-2xl p-4 text-left shadow-xs col-span-2 sm:col-span-1">
          <span className="block text-[10px] font-black text-gray-400 uppercase tracking-wider text-[#047857]">Revenue</span>
          <span className="block text-2xl font-black text-[#047857] mt-1 truncate">
        ...
        <div className="flex flex-col md:flex-row items-center gap-3.5">
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-10 pr-4 py-2.5 text-xs font-semibold focus:bg-white focus:border-[#047857] focus:outline-none transition-colors"
            />
          </div>
              ...
              return (
                <button
                  ...
                  className={`px-4 py-1.5 text-xs font-bold rounded-xl border transition-all ${
                    isActive
                      ? "bg-[#047857] border-[#047857] text-white shadow-sm"
        ...
        <div className="bg-white border border-gray-150 rounded-2xl shadow-xs overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-xs text-left animate-fade-in-top">
              <thead>
                <tr className="bg-gray-55/40 border-b border-gray-150 text-[10px] font-black text-gray-450 uppercase tracking-wider select-none">
                  <th className="px-5 py-4 w-6"><input type="checkbox" className="rounded border-gray-300 focus:ring-[#047857] accent-[#047857]" /></th>
                ...
                {filteredOrders.map((order) => {
                  ...
                  return (
                    <tr key={order.id} className="hover:bg-gray-50/30 transition-colors">
                      <td className="px-5 py-4"><input type="checkbox" className="rounded border-gray-300 focus:ring-[#047857] accent-[#047857]" /></td>
                      <td className="px-5 py-4">
                        <button
                          onClick={() => setSelectedOrderId(order.id)}
                          className="font-extrabold text-[#047857] hover:underline cursor-pointer block text-xs tracking-tight"
                        >
                      ...
                      <td className="px-5 py-4">
                        ...
                        <span className="text-[10px] text-gray-450 font-bold block mt-0.5">{order.email}</span>
                      </td>
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-1.5 truncate max-w-[200px]">
                          ...
                          {items.length > 1 && (
                            <span className="bg-gray-100 text-gray-550 font-bold text-[9px] px-1.5 py-0.5 rounded-md flex-shrink-0">
                              +{items.length - 1} more
                            </span>
                          )}
                        </div>
                      ...
                      <td className="px-5 py-4 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          <button
                            onClick={() => setSelectedOrderId(order.id)}
                            className="w-7 h-7 rounded-lg hover:bg-gray-100 flex items-center justify-center text-gray-400 hover:text-[#047857] transition-colors"
                            title="View Details"
                          >
